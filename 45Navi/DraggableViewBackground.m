...
-(void)setupView
{
  self.backgroundColor = [UIColor colorWithRed:52.0/256.0 +0.2	green:152.0/256.0 +0.2	blue:219.0/256.0 +0.2 alpha:1.0];
...
{
  [ArticlesCache sharedInstance].selectedIndex = cardsLoadedIndex-2;
